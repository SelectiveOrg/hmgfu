...
The 15 golden rules in `~/.claude/CLAUDE.md` are in force here.

## Runtime facts
- All models are local via Ollama: `gemma4:12b` (chat), `qwen2.5:1.5b-instruct` (sensitizer/dream nano), `nomic-embed-text` (embeddings).
